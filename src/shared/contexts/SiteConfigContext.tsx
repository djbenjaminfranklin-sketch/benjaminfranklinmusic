...
export interface SiteConfig {
  ...
  assets: { logo: string; logoTransparent: string; avatar: string; heroImage: string; bioImage: string; heroImagePosX: string; heroImagePosY: string; bioImagePosX: string; bioImagePosY: string };
