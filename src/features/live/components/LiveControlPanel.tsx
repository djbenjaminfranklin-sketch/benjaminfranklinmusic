...
export default function LiveControlPanel() {
  const { streamStatus, viewerCount, scheduledLive: liveScheduledLive, coHostStreams: viewerCoHostStreams, coHostNames, chatMessages, sendChatMessage, inviteRandomViewer, inviting, disconnectInvitedGuest, sseClientId } = useLiveStream();
